...
class ControladorUsuarios {
	...
	static public function ctrIngresoUsuario() {
		...
		if(isset($_POST["ingUsuario"])){
			if(preg_match('/^[a-zA-Z0-9ñÑ]+$/', $_POST["ingUsuario"]) &&
			   preg_match('/^[a-zA-Z0-9ñÑ]+$/', $_POST["ingPassword"])){
			   	...
			   	if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar){
					...
					echo '<br><div class="alert alert-danger">Error al ingresar, Revitas los datos y vuelve a intentar :)</div>';
...
static public function ctrCrearUsuario(){
	...
	if(isset($_POST["nuevoUsuario"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoNombre"]) &&
			   preg_match('/^[a-zA-Z0-9ñÑ]+$/', $_POST["nuevoUsuario"]) &&
