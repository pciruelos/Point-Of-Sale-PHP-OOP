       ...
       foreach ($usuarios as $key => $value){
          ...
          echo ' <tr>
                  ...
                  if($value["foto"] != ""){
                    ...
                    echo '<td><img src="views/img/usuarios/user.png" class="img-thumbnail" width="40px"></td>';
          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA SUBIR FOTO -->
             ...
             <div class="form-group">
              ...
              <img src="views/img/usuarios/user.png" class="img-thumbnail previsualizar" width="100px">
