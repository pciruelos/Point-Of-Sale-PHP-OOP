...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/logocompleto.gif"></td>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Dirección: Pringles 816, San Luis
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: 2664 426227
					
					<br>
					Detallesjugueteria@gmail.com
